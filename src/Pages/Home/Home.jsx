    ...
    <div className='App'>
     ...
     <div className='hero-container'>
        ...
        <div className='hero-content'>
          ...
          <p>Nemo enim ipsam voluptatem quia voluptas sit<br/>aspernatur aut odit aut fugit, sed quia consequuntur <br/>magni dolores eos qui ratione voluptatem<br/>
            sequi nesciunt.</p>
          <button className='hero-btn' onClick={handleLogin}>Get Started</button>
        </div>
